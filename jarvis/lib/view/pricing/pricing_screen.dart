...
class PricingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      final pricingViewModel = context.read<PricingViewModel>();
      ...
      return ShadApp.material(
        ...
        home: Selector<PricingViewModel, bool>(
          selector: (context, pricingViewModel) => pricingViewModel.isLoading,
          builder: (context, isLoading, child) {
            return isLoading
                ? MyScaffold(
                    resizeToAvoidBottomInset: true,
                    appBar:
                        TopAppBarWithDrawerIcon(isLargeScreen: isLargeScreen),
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: SizedBox(
                                                          width: 200,
                                                          child: pricingViewModel.subscription
                                                                          .name ==
                                                                      SubscriptionType
                                                                          .starter ||
                                                              pricingViewModel.subscription
                                                                          .name ==
                                                                      SubscriptionType
                                                                          .pro
                                                              ? const Text(
